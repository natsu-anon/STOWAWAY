* TODO TEST
  ...
  - [-] deadhead.js - yo, the CLI is major dicked [5/8]
	...
	- [ ] rework revoke sequence -- just use a form BRUH
	  - [ ] bruh cleanup all that stuff
	- [ ] use same revocation form during the key initialization
